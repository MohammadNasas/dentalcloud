...
export const DOWNLOADS = [
  { id: 'win64', os: 'windows', en: 'Windows (64-bit)', ar: 'ويندوز (64-بت)', note: { en: 'Most PCs', ar: 'أغلب الأجهزة' }, file: 'DentaCare-Windows-x64-Setup.exe' },
  { id: 'win32', os: 'windows', en: 'Windows (32-bit)', ar: 'ويندوز (32-بت)', note: { en: 'Older PCs', ar: 'أجهزة قديمة' }, file: 'DentaCare-Windows-ia32-Setup.exe' },
  { id: 'mac-arm', os: 'mac', en: 'macOS (Apple Silicon)', ar: 'ماك (Apple Silicon)', note: { en: 'M1/M2/M3', ar: 'M1/M2/M3' }, file: 'DentaCare-macOS-arm64.dmg' },
  { id: 'mac-intel', os: 'mac', en: 'macOS (Intel)', ar: 'ماك (Intel)', note: { en: 'Intel Macs', ar: 'أجهزة Intel' }, file: 'DentaCare-macOS-x64.dmg' },
]
