...
export const PACKAGE_FEATURES = {
  student: {
    ...
    features: [
      ...
      { en: 'Periodontal / gum chart', ar: 'مخطط اللثة' },
      { en: 'One X-ray image per patient', ar: 'صورة أشعة واحدة لكل مريض' },
      { en: '3 ready instruction sheets (extraction · RCT · gum care)', ar: '٣ أوراق تعليمات جاهزة (خلع · عصب · علاج اللثة)' },
  ...
  economy: {
    ...
    features: [
      ...
      { en: 'O’Leary plaque index + smart “top 3 teeth to treat”', ar: 'مؤشر اللويحة (O’Leary) + اقتراح «أهم 3 أسنان»' },
      { en: 'Full instruction-sheet library + your own custom sheets', ar: 'مكتبة أوراق التعليمات كاملة + أوراقك الخاصة' },
