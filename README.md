...
|---|---|---|
| 🎓 الطالب / Student | **$5** | السجلات، التاريخ الطبي، مخطط الأسنان، المدفوعات، تصدير Word |
| 🏢 التوفيرية / Economy | **$60** | + المواعيد، تعدد الأطباء، اللثة، مؤشر اللويحة، الأسعار، التذكيرات |
