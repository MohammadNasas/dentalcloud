...
|---|---|---|
| 🎓 الطالب / Student | **مجاني** | السجلات، مخطط الأسنان، مخطط اللثة، صورة أشعة واحدة، ٣ أوراق تعليمات |
| 👑 الاحترافية / Pro | **$50 سنوياً** | إدارة العيادة كاملة: المواعيد، تعدد الأطباء، الصور والأشعة، التقارير، المدفوعات والمختبر |
